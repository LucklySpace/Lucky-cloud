        ...
        return new BeanFactoryPostProcessor() {
            ...
            private boolean shouldBeEager(String className) {
                ...
                return className.contains("Controller") ||
                       ...
                       className.contains("AuthenticationProvider") ||
                       className.contains("PasswordEncoder") ||
            ...
            private boolean shouldBeLazy(String className) {
                ...
                return className.contains("Util") && !className.contains("ResponseUtil") ||
                       className.contains("Helper") ||
                       className.contains("Validator") ||
                       className.contains("QRCode") && !className.contains("Config");
            }
        };
    }
}
